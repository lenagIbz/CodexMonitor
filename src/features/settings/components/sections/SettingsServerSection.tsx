  ...
  return (
    <section className="settings-section">
      ...
      <div className="settings-section-subtitle">
        Configure how CodexMonitor exposes backend access for mobile and remote clients. Desktop
        usage remains local unless you explicitly connect through remote mode.
      </div>
      ...
      <>
        <div className="settings-field">
          ...
          <div className="settings-help">
            Select which remote transport configuration to maintain for mobile access and optional
            desktop remote-mode testing.
          </div>
        </div>
      ...
      <div className="settings-help">
        Mobile access should stay scoped to your own infrastructure (tailnet or self-hosted
        Orbit). CodexMonitor does not provide hosted backend services.
      </div>
    </section>
  );
}
